    ...
    public void pathupdate() {
        switch (pathState) {
            ...
            case START:
                if(pathing.update()) {
                    shoot();
                    pathing.setTarget(-415.6,-137.0,-37.62);
                    pathState = PathState.GOINTAKE1;
                }
                break;
            case GOINTAKE1:
                if(pathing.update()) {
                    pathing.setTarget(-192.9,-309.9,-37.62);
            ...
            case SHOOT1:
                if(pathing.update()) {
                    shoot();
                    pathing.setTarget(-547.3,-325.1,-37.62);
                    pathState = PathState.GOINTAKE2;
                }
                break;
            case GOINTAKE2:
                if(pathing.update()) {
                    pathing.setTarget(-339.9,-494.3,-37.62);
            ...
            case SHOOT2:
                if(pathing.update()) {
                    shoot();
                    pathing.setTarget(-709.8,-485.8,-37.62);
                    pathState = PathState.GOINTAKE3;
                }
                break;
            case GOINTAKE3:
                if(pathing.update()) {
                    pathing.setTarget(-480.7,-670.0,-37.62);
